-- module_id FavioTE-qbI5pKgxR16yj_NJ5vvgOLSHvBmPoI5Gsu4
-- module_id L9G1DYcUFTWe8xnaFQoFqtd1xdAWBSA5QpQ-HeVEFj8 (with json)
...
function dump(base, req)
  ...
  return {
    ...
    req = req,
    type_json = type(json),
    test_json = json.encode({ hello = "world", foo = { bar = 123, baz = true } })
